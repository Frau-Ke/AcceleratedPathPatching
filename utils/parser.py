...
add_args("--save_every_x_steps", default=0, type=int, help="store intermediate result every x steps")
...
add_args("--highest_sparsity", type=int, default=0, help="max sparsity")
add_args("--step_size", type=int, default=0, help="step size")
